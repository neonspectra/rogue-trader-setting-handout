% by neon at neosynth.net
% github: https://github.com/neonspectra/rogue-trader-setting-handout
% Copyleft 2025, under Creative Commons CC BY-SA 4.0 International https://creativecommons.org/licenses/by-sa/4.0/
%
...
\begin{itemize}
  ...
  \item Curiosity is seen as dangerous. Innovation is viewed as the road to heresy. “Monkey see, monkey do” is how the day-to-day affairs of the Imperium continue to run themselves as the empire declines.
\end{itemize}
...
\begin{itemize}
  ...
  \item A special kind of three-eyed mutant human called a Navigator is required to navigate the Warp. A ship’s Navigator is capable of looking directly into the Warp with their third eye to see the Emperor’s psychic presence on Terra. The Emperor's light—called the Astronomican—is a Navigator's North Star to determine the ship’s galactic heading; Warp travel would be impossible without it.
\end{itemize}
