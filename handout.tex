...
\fancyhead[C]{%
  \begin{tikzpicture}[remember picture, overlay]
    ...
    \node[anchor=east] at ([xshift=-1.2cm, yshift=-2.2cm]current page.north east) {\flufffont\Large CLASSIFIED // Page \Roman{page}};
...
\vspace{1.0cm} % Push body down below fluff header
